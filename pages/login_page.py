...
class LoginPage(BasePage):
    ...
    def verificar_mansagem_erro_login_existe(self):
    ...
    def verificar_texto_mensagem_erro_login(self, texto_esperado):
        ...
        assert texto_encontrado == texto_esperado, f"O texto encontrado '{texto_encontrado}', mas era esperado o texto '{texto_esperado}' "
